...
- HEAD_SHA: 0e6e9d24bc0a1164c01f61403e3d272840b25de9
...
CORS remains fail-closed: no default `*`; allowlist CSV or localhost-only. The `0e6e9d2` follow-up only imports `CSSProperties` explicitly in the toaster so the touched-path TypeScript gate compiles; it does not alter the hop chain.
