/**
 * Persistent rate limit for item model3d Meshy Image-to-3D (#141).
 * Location: supabase/functions/_shared/item-model3d-rate-limit.ts
 */

export interface ItemModel3dRateLimitConfig {
  url: string;
...
const RATE_LIMIT_RPC = '/rest/v1/rpc/consume_item_model3d_rate_limit';

export async function consumeItemModel3dRateLimit(
  config: ItemModel3dRateLimitConfig,
  userId: string,
