/**
 * Persistent rate limit for item thumbnail Meshy generation (#140).
 * Location: supabase/functions/_shared/item-thumbnail-rate-limit.ts
 */

export interface ItemThumbnailRateLimitConfig {
  url: string;
...
const RATE_LIMIT_RPC = '/rest/v1/rpc/consume_item_thumbnail_rate_limit';

export async function consumeItemThumbnailRateLimit(
  config: ItemThumbnailRateLimitConfig,
  userId: string,
