/**
 * SpeciesResistanceHazardItem — Gefahrenart-Option im Select mit eigenem Tooltip.
 * Label geht in ItemText (Trigger); Beschreibung nur im Hilfe-Tooltip am Eintrag.
 * Location: src/modules/characters/components/SpeciesResistanceHazardItem.tsx
 */
...
import type { SagaDriveNarrowResistanceHazardOption } from '../../rulesets/speciesResistanceHazards';

type SpeciesResistanceHazardItemProps = {
  option: SagaDriveNarrowResistanceHazardOption;
};

export function SpeciesResistanceHazardItem({ option }: SpeciesResistanceHazardItemProps) {
